...
select Nombre, Edad from POKEMON;

#Ejercicio 4.- Muestra todos los nombres de los pokemon ordenados alfabéticamente.

select Nombre from POKEMON order by Nombre asc; # Para ordenar a la inversa alfabéticamente se usa desc

#Ejercicio 5.- Muestra todos los nombres y edad de los pokemon ordenados de mayor a menor.

select Nombre, Edad from POKEMON order by edad desc;
...
select Tipo, Nombre from POKEMON order by Tipo asc, nombre desc;

#Ejercicio 11.- Muestra los 3 pokemon de más edad, ordenador de mayor a menor.

select Edad from POKEMON order by Edad desc limit 3;
